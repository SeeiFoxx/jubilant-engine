...
box_3 = font.render(text_3, True, unselected_color, unselected_bg_color)
screen.blit(box_1, box_1_pos)
screen.blit(box_2, box_2_pos)
screen.blit(box_3, box_3_pos)
        ...
        if event.type == pygame.QUIT:
            ...
            if event.key == pygame.K_UP or event.key == pygame.K_DOWN:
                ...
                if current_box == 1:
                    ...
                    box_1 = font.render(text_1, True, unselected_color, unselected_bg_color)
                    box_2 = font.render(text_2, True, unselected_color, unselected_bg_color)
                    box_3 = font.render(text_3, True, selected_color, selected_bg_color)
                    arrow_pos = (box_3_pos[0] - arrow_image.get_width(), box_3_pos[1])
